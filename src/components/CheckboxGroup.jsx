...
const CheckboxGroup = ({ label, options, selectedValues, onChange }) => {
  ...
  return (
    <div className=" ml-16  mb-4 flex flex-col md:flex-row md:items-center">
      <label className="block text-[#5792cf] font-medium md:w-28 text-right">{label}</label>
      <div className="flex justify-start ml-8 flex-wrap font-small">
        {options.map((option) => (
